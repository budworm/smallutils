...
public class CacheUtil {
    ...
    public static void clearAllCache(Context context) {
        ZFileUtil.deleteFile(getInternalCacheDirectory(context, null));
        ZFileUtil.deleteFile(getExternalCacheDirectory(context, null));
    }
    ...
    public static long getTotalCacheSize(Context context) {
        long cacheSize = ZFileUtil.getFileSize(getInternalCacheDirectory(context, null));
        cacheSize += ZFileUtil.getFileSize(getExternalCacheDirectory(context, null));
        return cacheSize;
    }
